...
describe('selectSeatController', () => {
    ...
    test('should reserve an available seat', () => __awaiter(void 0, void 0, void 0, function* () {
        show_model_1.Show.findById.mockResolvedValue({
            _id: showId,
            seats: [{ x: 1, y: 1, status: enum_1.SeatStatus.Available }],
            save: jest.fn(),
        });
        yield (0, socket_controller_1.selectSeatController)(mockSocket, { showId, x: 1, y: 1 });
    ...
    test('should return failure if seat is already reserved', () => __awaiter(void 0, void 0, void 0, function* () {
        show_model_1.Show.findById.mockResolvedValue({
            _id: showId,
...
//# sourceMappingURL=selectSeat.test.js.map