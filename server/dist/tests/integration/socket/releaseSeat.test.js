...
describe('releaseSeatController', () => {
    ...
    test('should release a reserved seat and make it available', () => __awaiter(void 0, void 0, void 0, function* () {
        show_model_1.Show.findById.mockResolvedValue({
            _id: showId,
            seats: [{ x: 1, y: 1, status: enum_1.SeatStatus.Reserved }],
            save: jest.fn(),
        });
        yield (0, socket_controller_1.releaseSeatController)(mockSocket, { showId, x: 1, y: 1 });
        ...
        expect((yield show_model_1.Show.findById(showId)).seats[0].status).toBe(enum_1.SeatStatus.Available);
    }));
...
//# sourceMappingURL=releaseSeat.test.js.map